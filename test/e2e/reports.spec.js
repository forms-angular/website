...
describe('Reports', function () {
  ...
  it('should do simple pipeline reports', function () {
    browser.get('/#/analyse/g_conditional_field?r=%5B%7B%22$group%22:%7B%22_id%22:%22$sex%22,%22count%22:%7B%22$sum%22:1%7D%7D%7D%5D');
  ...
  it('should do reports with options from the command line', function () {
    browser.get('/#/analyse/g_conditional_field?r={"pipeline":[{"$group":{"_id":"$sex","count":{"$sum":1}}}],"title":"Breakdown By Sex"' +
  ...
  it('should generate a default report', function () {
    ...
    element.all(by.css('div.ng-scope.ngRow.odd > div.ngCell.col0.colt0 > div:nth-child(2) > div > span')).first().click();
